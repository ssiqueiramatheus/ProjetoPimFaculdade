package com.matheus.todo.repositories;
...
public interface TodoRepository extends JpaRepository<Todo, Integer>{
	...
	//busca no banco de dados os que não foi finalizada a atividade
	@Query("SELECT obj FROM Todo obj WHERE obj.finalizado = false ORDER BY obj.dataParaFinalizar")
	List<Todo> findAllOpen();
    
	//busca no banco de dados os que foi finalizada a atividade
